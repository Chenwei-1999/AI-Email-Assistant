...
def build_prompt(email: EmailItem) -> str:
    return (
        ...
        "- If the sender asks for admission/supervision/funding/space or any resource commitment, treat it as \"important\" unless the email is purely a general inquiry with no ask for commitment.\n\n"
        "Output requirements:\n"
